 ...
 */
package org.patronus.fractal.ui.MFDFA;
...
public class MfdfaList implements Serializable {
    ...
    private List<Map<String, Object>> deleteMFDFAList;
    ...
    public String deleteMFDFAResults() {
        ...
        for (Map<String, Object> deleteMFDFA : deleteMFDFAList) {
            fractalDTO.setFractalTermInstance(deleteMFDFA);
    ...
    public List<Map<String, Object>> getDeleteMFDFAList() {
        return deleteMFDFAList;
    }

    public void setDeleteMFDFAList(List<Map<String, Object>> deleteMFDFAList) {
        this.deleteMFDFAList = deleteMFDFAList;
    }
